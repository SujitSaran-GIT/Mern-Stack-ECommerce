      ...
      <div className="flex justify-center align-center md:flex md:space-x-4">
        ...
        <h2 className="text-2xl font-semibold mb-4">Update Profile</h2>
            <form action="" onSubmit={submitHandler}>
              <div className="mb-4">
              <label htmlFor="" className="block text-white mb-2">Name</label>
                <input type="text" 
              ...
              <div className="flex justify-between">
                ...
                <Link to={'/user-orders'} className='bg-pink-600 text-white py-2 px-4 rounded hover:bg-pin-700'>My orders</Link>
              </div>
            </form>
        </div>
