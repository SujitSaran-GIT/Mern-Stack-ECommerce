...
const AdminDashboard = () => {
  ...
  const isDataLoading = loadingSales || loadingCustomers || loadingOrders;

  const totalSales = sales?.totalSales?.toFixed(2) || "0.00";
        ...
        <div className="w-[80%] flex justify-around flex-wrap">
          <div className="rounded-lg bg-black p-5 w-[20rem] mt-5">
            ...
            <h1 className="text-xl font-bold">
              $ {isDataLoading ? <Loader /> : totalSales}
            </h1>
          </div>
          <div className="rounded-lg bg-black p-5 w-[20rem] mt-5">
            <div className="font-bold rounded-full w-[3rem] bg-pink-500 text-center p-3">
            ...
            <h1 className="text-xl font-bold">
              {isDataLoading ? <Loader /> : totalCustomers}
            </h1>
          </div>
          <div className="rounded-lg bg-black p-5 w-[20rem] mt-5">
            <div className="font-bold rounded-full w-[3rem] bg-pink-500 text-center p-3">
            ...
            <h1 className="text-xl font-bold">
              {isDataLoading ? <Loader /> : totalOrders}
            </h1>
          </div>
        </div>
